  ...
  if (redirect) {
    ...
    return(
        ...
        <AccountNav />
          ...
          {perInput('Title','title for your place.')}

            <input type="text" 
            value ={title} onChange = {ev => setTitle(ev.target.value)} 
            placeholder="title, for example: 123department" />
          ...
          {perInput('Photos','Photos about your place.')}
           ...
           {perInput('Perks','Select all the perks from your place')}
          ...
          {perInput('Extra info','House Rules, etc')}
           ...
           {perInput('Check in&out times','Check in and out times, remember to have some time')}
        <div className="grid gap-2 grid-cols-2 md:grip-cols-4">
            <div>
